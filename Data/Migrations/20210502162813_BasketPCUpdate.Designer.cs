...
namespace EZPCBuilder.Data.Migrations
{
    ...
    [Migration("20210502162813_BasketPCUpdate")]
    partial class BasketPCUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EZPCBuilder.Models.Basket", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EZPCBuilder.Models.ProjectRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EZPCBuilder.Models.Basket", b =>
                {
                    b.HasOne("EZPCBuilder.Models.PC", "PC")
                        .WithMany()
                        .HasForeignKey("PCID")
